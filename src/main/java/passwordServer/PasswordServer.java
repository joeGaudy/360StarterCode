...
public class PasswordServer
{
	...
	public String homePage() {
	    return "<html><body>" +
	        ...
	        "<li><a href='request/joegaudy'>request/:username</a> Request for a password with your username.</li>" +
	        "<li><a href='auth/joegaudy/2432'>auth/:username/:password</a> Authenticates the password for your username.</li>" +
	        "</ol>" +
	        "</body></html>";
	}
